...
public class MergingTables {
    ...
    void merge(Table destination, Table source) {
        ...
        if (realDestination.rank > realSource.rank) {
        	...
        	if (realDestination.numberOfRows > maximumNumberOfRows) maximumNumberOfRows = realDestination.numberOfRows;
        } else {
        	...
        	if (realSource.numberOfRows > maximumNumberOfRows) maximumNumberOfRows = realSource.numberOfRows;
        }
    }
